...
exports.CreateManyAndReturnTodo = void 0;
const TypeGraphQL = __importStar(require("type-graphql"));
const User_1 = require("../../models/User");
let CreateManyAndReturnTodo = (() => {
    let _classDecorators = [TypeGraphQL.ObjectType("CreateManyAndReturnTodo", {})];
    ...
    var CreateManyAndReturnTodo = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "CreateManyAndReturnTodo");
    (() => {
        ...
        _user_decorators = [TypeGraphQL.Field(_type => User_1.User, {
                nullable: false
            })];
        ...
        CreateManyAndReturnTodo = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CreateManyAndReturnTodo = _classThis;
})();
exports.CreateManyAndReturnTodo = CreateManyAndReturnTodo;
