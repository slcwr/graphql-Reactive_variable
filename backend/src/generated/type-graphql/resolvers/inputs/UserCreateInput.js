...
const TodoCreateNestedManyWithoutUserInput_1 = require("../inputs/TodoCreateNestedManyWithoutUserInput");
let UserCreateInput = (() => {
    let _classDecorators = [TypeGraphQL.InputType("UserCreateInput", {})];
    ...
    var UserCreateInput = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "UserCreateInput");
    (() => {
        ...
        _todos_decorators = [TypeGraphQL.Field(_type => TodoCreateNestedManyWithoutUserInput_1.TodoCreateNestedManyWithoutUserInput, {
                nullable: true
            })];
        ...
        UserCreateInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UserCreateInput = _classThis;
})();
