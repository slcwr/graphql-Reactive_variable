...
exports.getConnection = exports.createDatabaseConnection = void 0;
exports.initializeDatabase = initializeDatabase;
// data-source.ts
require("reflect-metadata");
var typeorm_1 = require("typeorm");
var Users_js_1 = require("./entity/Users.js");
var Todo_js_1 = require("./entity/Todo.js");
...
var connectionOptions = {
    ...
    entities: [Users_js_1.Users, Todo_js_1.Todo],
    migrations: ["src/migration/**/*.ts"],
    subscribers: [],
};
exports.default = connectionOptions;
// 接続を作成する関数をエクスポート
var createDatabaseConnection = function () { return (0, typeorm_1.createConnection)(connectionOptions); };
...
var getConnection = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                error_2 = _a.sent();
                console.error('Error connecting to database:', error_2);
                throw error_2;
            case 4: return [2 /*return*/, connection];
        }
    });
