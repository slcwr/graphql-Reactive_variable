...
let DateTimeFilter = (() => {
    let _classDecorators = [TypeGraphQL.InputType("DateTimeFilter", {})];
    ...
    var DateTimeFilter = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "DateTimeFilter");
    (() => {
        ...
        _not_decorators = [TypeGraphQL.Field(_type => NestedDateTimeFilter_1.NestedDateTimeFilter, {
                nullable: true
            })];
