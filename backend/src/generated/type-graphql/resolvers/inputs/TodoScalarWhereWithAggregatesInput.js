...
let TodoScalarWhereWithAggregatesInput = (() => {
    let _classDecorators = [TypeGraphQL.InputType("TodoScalarWhereWithAggregatesInput", {})];
    ...
    var TodoScalarWhereWithAggregatesInput = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "TodoScalarWhereWithAggregatesInput");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _AND_decorators = [TypeGraphQL.Field(_type => [TodoScalarWhereWithAggregatesInput], {
                nullable: true
            })];
        _OR_decorators = [TypeGraphQL.Field(_type => [TodoScalarWhereWithAggregatesInput], {
                nullable: true
            })];
        _NOT_decorators = [TypeGraphQL.Field(_type => [TodoScalarWhereWithAggregatesInput], {
                nullable: true
            })];
        _id_decorators = [TypeGraphQL.Field(_type => IntWithAggregatesFilter_1.IntWithAggregatesFilter, {
                nullable: true
            })];
        _description_decorators = [TypeGraphQL.Field(_type => StringWithAggregatesFilter_1.StringWithAggregatesFilter, {
                nullable: true
            })];
        ...
        _userId_decorators = [TypeGraphQL.Field(_type => IntWithAggregatesFilter_1.IntWithAggregatesFilter, {
                nullable: true
            })];
        ...
        TodoScalarWhereWithAggregatesInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TodoScalarWhereWithAggregatesInput = _classThis;
})();
