...
exports.UserCreateOrConnectWithoutTodosInput = void 0;
const TypeGraphQL = __importStar(require("type-graphql"));
const UserCreateWithoutTodosInput_1 = require("../inputs/UserCreateWithoutTodosInput");
const UserWhereUniqueInput_1 = require("../inputs/UserWhereUniqueInput");
let UserCreateOrConnectWithoutTodosInput = (() => {
    let _classDecorators = [TypeGraphQL.InputType("UserCreateOrConnectWithoutTodosInput", {})];
    ...
    var UserCreateOrConnectWithoutTodosInput = _classThis = class {
        constructor() {
            this.where = __runInitializers(this, _where_initializers, void 0);
            this.create = (__runInitializers(this, _where_extraInitializers), __runInitializers(this, _create_initializers, void 0));
            __runInitializers(this, _create_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "UserCreateOrConnectWithoutTodosInput");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _where_decorators = [TypeGraphQL.Field(_type => UserWhereUniqueInput_1.UserWhereUniqueInput, {
                nullable: false
            })];
        ...
        UserCreateOrConnectWithoutTodosInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UserCreateOrConnectWithoutTodosInput = _classThis;
})();
exports.UserCreateOrConnectWithoutTodosInput = UserCreateOrConnectWithoutTodosInput;
