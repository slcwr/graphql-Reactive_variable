...
let IntWithAggregatesFilter = (() => {
    let _classDecorators = [TypeGraphQL.InputType("IntWithAggregatesFilter", {})];
    ...
    var IntWithAggregatesFilter = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "IntWithAggregatesFilter");
    (() => {
        ...
        _not_decorators = [TypeGraphQL.Field(_type => NestedIntWithAggregatesFilter_1.NestedIntWithAggregatesFilter, {
                nullable: true
            })];
        ...
        IntWithAggregatesFilter = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return IntWithAggregatesFilter = _classThis;
})();
