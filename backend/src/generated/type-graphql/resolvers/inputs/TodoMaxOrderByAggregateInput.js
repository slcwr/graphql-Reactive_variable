...
let TodoMaxOrderByAggregateInput = (() => {
    let _classDecorators = [TypeGraphQL.InputType("TodoMaxOrderByAggregateInput", {})];
    ...
    var TodoMaxOrderByAggregateInput = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "TodoMaxOrderByAggregateInput");
    (() => {
        ...
        TodoMaxOrderByAggregateInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TodoMaxOrderByAggregateInput = _classThis;
})();
