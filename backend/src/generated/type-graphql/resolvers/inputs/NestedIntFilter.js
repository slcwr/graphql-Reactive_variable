...
let NestedIntFilter = (() => {
    let _classDecorators = [TypeGraphQL.InputType("NestedIntFilter", {})];
    ...
    var NestedIntFilter = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "NestedIntFilter");
    (() => {
        ...
        _not_decorators = [TypeGraphQL.Field(_type => NestedIntFilter, {
                nullable: true
            })];
        ...
        NestedIntFilter = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return NestedIntFilter = _classThis;
})();
