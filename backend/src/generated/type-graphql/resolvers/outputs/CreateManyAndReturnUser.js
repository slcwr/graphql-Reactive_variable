...
let CreateManyAndReturnUser = (() => {
    let _classDecorators = [TypeGraphQL.ObjectType("CreateManyAndReturnUser", {})];
    ...
    var CreateManyAndReturnUser = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "CreateManyAndReturnUser");
    (() => {
        ...
        CreateManyAndReturnUser = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CreateManyAndReturnUser = _classThis;
})();
