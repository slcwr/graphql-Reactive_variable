...
let UpdateManyTodoArgs = (() => {
    ...
    var UpdateManyTodoArgs = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "UpdateManyTodoArgs");
    (() => {
        ...
        UpdateManyTodoArgs = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UpdateManyTodoArgs = _classThis;
})();
