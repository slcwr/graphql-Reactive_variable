...
let FindFirstUserResolver = (() => {
    ...
    var FindFirstUserResolver = _classThis = class {
    ...
    __setFunctionName(_classThis, "FindFirstUserResolver");
    (() => {
        ...
        FindFirstUserResolver = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return FindFirstUserResolver = _classThis;
})();
