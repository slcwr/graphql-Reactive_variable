...
let UserTodosArgs = (() => {
    ...
    var UserTodosArgs = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "UserTodosArgs");
    (() => {
        ...
        UserTodosArgs = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UserTodosArgs = _classThis;
})();
exports.UserTodosArgs = UserTodosArgs;
