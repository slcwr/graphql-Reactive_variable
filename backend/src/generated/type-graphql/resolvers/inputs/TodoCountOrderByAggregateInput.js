...
let TodoCountOrderByAggregateInput = (() => {
    let _classDecorators = [TypeGraphQL.InputType("TodoCountOrderByAggregateInput", {})];
    ...
    var TodoCountOrderByAggregateInput = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "TodoCountOrderByAggregateInput");
    (() => {
        ...
        TodoCountOrderByAggregateInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TodoCountOrderByAggregateInput = _classThis;
})();
