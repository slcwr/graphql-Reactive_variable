...
let CreateManyAndReturnUserArgs = (() => {
    ...
    var CreateManyAndReturnUserArgs = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "CreateManyAndReturnUserArgs");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _data_decorators = [TypeGraphQL.Field(_type => [UserCreateManyInput_1.UserCreateManyInput], {
                nullable: false
            })];
        ...
        CreateManyAndReturnUserArgs = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CreateManyAndReturnUserArgs = _classThis;
})();
