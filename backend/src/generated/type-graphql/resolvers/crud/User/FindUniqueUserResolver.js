...
let FindUniqueUserResolver = (() => {
    ...
    var FindUniqueUserResolver = _classThis = class {
        user(ctx, info, args) {
    ...
    __setFunctionName(_classThis, "FindUniqueUserResolver");
    (() => {
        ...
        FindUniqueUserResolver = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return FindUniqueUserResolver = _classThis;
})();
