...
let CreateManyUserResolver = (() => {
    ...
    var CreateManyUserResolver = _classThis = class {
    ...
    __setFunctionName(_classThis, "CreateManyUserResolver");
    (() => {
        ...
        CreateManyUserResolver = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CreateManyUserResolver = _classThis;
})();
