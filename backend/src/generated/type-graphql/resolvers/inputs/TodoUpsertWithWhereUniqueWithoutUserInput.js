...
exports.TodoUpsertWithWhereUniqueWithoutUserInput = void 0;
const TypeGraphQL = __importStar(require("type-graphql"));
const TodoCreateWithoutUserInput_1 = require("../inputs/TodoCreateWithoutUserInput");
const TodoUpdateWithoutUserInput_1 = require("../inputs/TodoUpdateWithoutUserInput");
const TodoWhereUniqueInput_1 = require("../inputs/TodoWhereUniqueInput");
let TodoUpsertWithWhereUniqueWithoutUserInput = (() => {
    let _classDecorators = [TypeGraphQL.InputType("TodoUpsertWithWhereUniqueWithoutUserInput", {})];
    ...
    var TodoUpsertWithWhereUniqueWithoutUserInput = _classThis = class {
        constructor() {
            this.where = __runInitializers(this, _where_initializers, void 0);
            this.update = (__runInitializers(this, _where_extraInitializers), __runInitializers(this, _update_initializers, void 0));
            this.create = (__runInitializers(this, _update_extraInitializers), __runInitializers(this, _create_initializers, void 0));
            __runInitializers(this, _create_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "TodoUpsertWithWhereUniqueWithoutUserInput");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _where_decorators = [TypeGraphQL.Field(_type => TodoWhereUniqueInput_1.TodoWhereUniqueInput, {
                nullable: false
            })];
        _update_decorators = [TypeGraphQL.Field(_type => TodoUpdateWithoutUserInput_1.TodoUpdateWithoutUserInput, {
                nullable: false
            })];
        ...
        TodoUpsertWithWhereUniqueWithoutUserInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TodoUpsertWithWhereUniqueWithoutUserInput = _classThis;
})();
exports.TodoUpsertWithWhereUniqueWithoutUserInput = TodoUpsertWithWhereUniqueWithoutUserInput;
