...
let DateTimeFieldUpdateOperationsInput = (() => {
    let _classDecorators = [TypeGraphQL.InputType("DateTimeFieldUpdateOperationsInput", {})];
    ...
    var DateTimeFieldUpdateOperationsInput = _classThis = class {
        constructor() {
            this.set = __runInitializers(this, _set_initializers, void 0);
            __runInitializers(this, _set_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "DateTimeFieldUpdateOperationsInput");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _set_decorators = [TypeGraphQL.Field(_type => Date, {
                nullable: true
            })];
        ...
        DateTimeFieldUpdateOperationsInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return DateTimeFieldUpdateOperationsInput = _classThis;
})();
