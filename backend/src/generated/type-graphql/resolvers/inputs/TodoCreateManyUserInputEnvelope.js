...
exports.TodoCreateManyUserInputEnvelope = void 0;
const TypeGraphQL = __importStar(require("type-graphql"));
const TodoCreateManyUserInput_1 = require("../inputs/TodoCreateManyUserInput");
let TodoCreateManyUserInputEnvelope = (() => {
    let _classDecorators = [TypeGraphQL.InputType("TodoCreateManyUserInputEnvelope", {})];
    ...
    var TodoCreateManyUserInputEnvelope = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "TodoCreateManyUserInputEnvelope");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _data_decorators = [TypeGraphQL.Field(_type => [TodoCreateManyUserInput_1.TodoCreateManyUserInput], {
                nullable: false
            })];
        ...
        TodoCreateManyUserInputEnvelope = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TodoCreateManyUserInputEnvelope = _classThis;
})();
exports.TodoCreateManyUserInputEnvelope = TodoCreateManyUserInputEnvelope;
