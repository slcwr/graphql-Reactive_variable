...
let TodoMaxAggregate = (() => {
    let _classDecorators = [TypeGraphQL.ObjectType("TodoMaxAggregate", {})];
    ...
    var TodoMaxAggregate = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "TodoMaxAggregate");
    (() => {
        ...
        TodoMaxAggregate = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TodoMaxAggregate = _classThis;
})();
