...
let GroupByTodoArgs = (() => {
    ...
    var GroupByTodoArgs = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "GroupByTodoArgs");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _where_decorators = [TypeGraphQL.Field(_type => TodoWhereInput_1.TodoWhereInput, {
                nullable: true
            })];
        _orderBy_decorators = [TypeGraphQL.Field(_type => [TodoOrderByWithAggregationInput_1.TodoOrderByWithAggregationInput], {
                nullable: true
            })];
        _by_decorators = [TypeGraphQL.Field(_type => [TodoScalarFieldEnum_1.TodoScalarFieldEnum], {
                nullable: false
            })];
        _having_decorators = [TypeGraphQL.Field(_type => TodoScalarWhereWithAggregatesInput_1.TodoScalarWhereWithAggregatesInput, {
                nullable: true
            })];
        ...
        GroupByTodoArgs = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return GroupByTodoArgs = _classThis;
})();
