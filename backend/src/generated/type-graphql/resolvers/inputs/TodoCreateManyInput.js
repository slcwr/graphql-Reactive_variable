...
let TodoCreateManyInput = (() => {
    let _classDecorators = [TypeGraphQL.InputType("TodoCreateManyInput", {})];
    ...
    var TodoCreateManyInput = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "TodoCreateManyInput");
    (() => {
        ...
        TodoCreateManyInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TodoCreateManyInput = _classThis;
})();
