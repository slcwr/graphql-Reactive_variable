...
let UserOrderByWithAggregationInput = (() => {
    let _classDecorators = [TypeGraphQL.InputType("UserOrderByWithAggregationInput", {})];
    ...
    var UserOrderByWithAggregationInput = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "UserOrderByWithAggregationInput");
    (() => {
        ...
        __count_decorators = [TypeGraphQL.Field(_type => UserCountOrderByAggregateInput_1.UserCountOrderByAggregateInput, {
                nullable: true
            })];
        __avg_decorators = [TypeGraphQL.Field(_type => UserAvgOrderByAggregateInput_1.UserAvgOrderByAggregateInput, {
                nullable: true
            })];
        __max_decorators = [TypeGraphQL.Field(_type => UserMaxOrderByAggregateInput_1.UserMaxOrderByAggregateInput, {
                nullable: true
            })];
        __min_decorators = [TypeGraphQL.Field(_type => UserMinOrderByAggregateInput_1.UserMinOrderByAggregateInput, {
                nullable: true
            })];
        __sum_decorators = [TypeGraphQL.Field(_type => UserSumOrderByAggregateInput_1.UserSumOrderByAggregateInput, {
                nullable: true
            })];
        ...
        UserOrderByWithAggregationInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UserOrderByWithAggregationInput = _classThis;
})();
