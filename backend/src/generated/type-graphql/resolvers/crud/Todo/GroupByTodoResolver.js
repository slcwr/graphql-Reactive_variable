...
let GroupByTodoResolver = (() => {
    ...
    var GroupByTodoResolver = _classThis = class {
    ...
    __setFunctionName(_classThis, "GroupByTodoResolver");
    (() => {
        ...
        GroupByTodoResolver = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return GroupByTodoResolver = _classThis;
})();
