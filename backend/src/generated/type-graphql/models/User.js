...
let User = (() => {
    let _classDecorators = [TypeGraphQL.ObjectType("User", {})];
    ...
    var User = _classThis = class {
        constructor() {
            ...
            this.todos = __runInitializers(this, _password_extraInitializers);
    ...
    (() => {
        ...
        __count_decorators = [TypeGraphQL.Field(_type => UserCount_1.UserCount, {
                nullable: true
            })];
