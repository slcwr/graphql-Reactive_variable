...
let IntFilter = (() => {
    let _classDecorators = [TypeGraphQL.InputType("IntFilter", {})];
    ...
    var IntFilter = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "IntFilter");
    (() => {
        ...
        _not_decorators = [TypeGraphQL.Field(_type => NestedIntFilter_1.NestedIntFilter, {
                nullable: true
            })];
        ...
        IntFilter = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return IntFilter = _classThis;
})();
