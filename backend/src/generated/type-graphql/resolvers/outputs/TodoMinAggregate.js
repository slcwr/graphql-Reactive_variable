...
let TodoMinAggregate = (() => {
    let _classDecorators = [TypeGraphQL.ObjectType("TodoMinAggregate", {})];
    ...
    var TodoMinAggregate = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "TodoMinAggregate");
    (() => {
        ...
        TodoMinAggregate = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TodoMinAggregate = _classThis;
})();
