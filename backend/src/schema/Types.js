...
let User = (() => {
    ...
    var User = _classThis = class {
        constructor() {
            ...
            this.password = __runInitializers(this, _username_extraInitializers);
            this.todos = __runInitializers(this, _todos_initializers, void 0); // オプショナルに変更
            this.createdAt = (__runInitializers(this, _todos_extraInitializers), __runInitializers(this, _createdAt_initializers, void 0));
    ...
    (() => {
        ...
        _id_decorators = [(0, type_graphql_1.Field)(() => type_graphql_1.Int)];
        _username_decorators = [(0, type_graphql_1.Field)(() => String)];
        _todos_decorators = [(0, type_graphql_1.Field)(() => [Todo], { nullable: true })];
        _createdAt_decorators = [(0, type_graphql_1.Field)(() => Date)];
        _updatedAt_decorators = [(0, type_graphql_1.Field)(() => Date)];
...
let Todo = (() => {
    ...
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_decorators = [(0, type_graphql_1.Field)(() => type_graphql_1.Int)];
        _description_decorators = [(0, type_graphql_1.Field)(() => String)];
        _createdAt_decorators = [(0, type_graphql_1.Field)(() => Date)];
        _updatedAt_decorators = [(0, type_graphql_1.Field)(() => Date)];
        _userId_decorators = [(0, type_graphql_1.Field)(() => type_graphql_1.Int)];
        _user_decorators = [(0, type_graphql_1.Field)(() => User)];
        __esDecorate(null, null, _id_decorators, { kind: "field", name: "id", static: false, private: false, access: { has: obj => "id" in obj, get: obj => obj.id, set: (obj, value) => { obj.id = value; } }, metadata: _metadata }, _id_initializers, _id_extraInitializers);
