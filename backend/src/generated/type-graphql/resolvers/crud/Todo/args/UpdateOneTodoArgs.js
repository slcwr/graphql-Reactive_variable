...
let UpdateOneTodoArgs = (() => {
    ...
    var UpdateOneTodoArgs = _classThis = class {
        constructor() {
            this.data = __runInitializers(this, _data_initializers, void 0);
            this.where = (__runInitializers(this, _data_extraInitializers), __runInitializers(this, _where_initializers, void 0));
            __runInitializers(this, _where_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "UpdateOneTodoArgs");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _data_decorators = [TypeGraphQL.Field(_type => TodoUpdateInput_1.TodoUpdateInput, {
                nullable: false
            })];
        ...
        UpdateOneTodoArgs = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UpdateOneTodoArgs = _classThis;
})();
