...
let GroupByUserResolver = (() => {
    ...
    var GroupByUserResolver = _classThis = class {
    ...
    __setFunctionName(_classThis, "GroupByUserResolver");
    (() => {
        ...
        GroupByUserResolver = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return GroupByUserResolver = _classThis;
})();
