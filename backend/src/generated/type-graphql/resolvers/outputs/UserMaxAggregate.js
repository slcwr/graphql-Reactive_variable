...
let UserMaxAggregate = (() => {
    let _classDecorators = [TypeGraphQL.ObjectType("UserMaxAggregate", {})];
    ...
    var UserMaxAggregate = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "UserMaxAggregate");
    (() => {
        ...
        UserMaxAggregate = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UserMaxAggregate = _classThis;
})();
