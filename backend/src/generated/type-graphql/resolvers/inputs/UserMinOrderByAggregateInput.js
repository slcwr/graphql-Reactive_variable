...
let UserMinOrderByAggregateInput = (() => {
    let _classDecorators = [TypeGraphQL.InputType("UserMinOrderByAggregateInput", {})];
    ...
    var UserMinOrderByAggregateInput = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "UserMinOrderByAggregateInput");
    (() => {
        ...
        UserMinOrderByAggregateInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UserMinOrderByAggregateInput = _classThis;
})();
