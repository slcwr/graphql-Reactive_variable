...
exports.UserCreateWithoutTodosInput = void 0;
const TypeGraphQL = __importStar(require("type-graphql"));
let UserCreateWithoutTodosInput = (() => {
    let _classDecorators = [TypeGraphQL.InputType("UserCreateWithoutTodosInput", {})];
    ...
    var UserCreateWithoutTodosInput = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "UserCreateWithoutTodosInput");
    (() => {
        ...
        UserCreateWithoutTodosInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UserCreateWithoutTodosInput = _classThis;
})();
exports.UserCreateWithoutTodosInput = UserCreateWithoutTodosInput;
