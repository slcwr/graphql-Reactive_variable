...
let UpsertOneUserArgs = (() => {
    ...
    var UpsertOneUserArgs = _classThis = class {
        constructor() {
            ...
            this.update = (__runInitializers(this, _create_extraInitializers), __runInitializers(this, _update_initializers, void 0));
            __runInitializers(this, _update_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "UpsertOneUserArgs");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _where_decorators = [TypeGraphQL.Field(_type => UserWhereUniqueInput_1.UserWhereUniqueInput, {
                nullable: false
            })];
        _create_decorators = [TypeGraphQL.Field(_type => UserCreateInput_1.UserCreateInput, {
                nullable: false
            })];
        _update_decorators = [TypeGraphQL.Field(_type => UserUpdateInput_1.UserUpdateInput, {
                nullable: false
            })];
        ...
        UpsertOneUserArgs = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UpsertOneUserArgs = _classThis;
})();
