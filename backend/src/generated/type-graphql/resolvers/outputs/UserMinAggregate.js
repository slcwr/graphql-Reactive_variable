...
let UserMinAggregate = (() => {
    let _classDecorators = [TypeGraphQL.ObjectType("UserMinAggregate", {})];
    ...
    var UserMinAggregate = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "UserMinAggregate");
    (() => {
        ...
        UserMinAggregate = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UserMinAggregate = _classThis;
})();
