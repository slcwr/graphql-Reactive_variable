...
let TodoWhereUniqueInput = (() => {
    let _classDecorators = [TypeGraphQL.InputType("TodoWhereUniqueInput", {})];
    ...
    var TodoWhereUniqueInput = _classThis = class {
        constructor() {
            this.id = __runInitializers(this, _id_initializers, void 0);
            this.AND = (__runInitializers(this, _id_extraInitializers), __runInitializers(this, _AND_initializers, void 0));
            ...
            this.description = (__runInitializers(this, _NOT_extraInitializers), __runInitializers(this, _description_initializers, void 0));
    ...
    __setFunctionName(_classThis, "TodoWhereUniqueInput");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_decorators = [TypeGraphQL.Field(_type => TypeGraphQL.Int, {
                nullable: true
            })];
        _AND_decorators = [TypeGraphQL.Field(_type => [TodoWhereInput_1.TodoWhereInput], {
                nullable: true
            })];
        _OR_decorators = [TypeGraphQL.Field(_type => [TodoWhereInput_1.TodoWhereInput], {
                nullable: true
            })];
        _NOT_decorators = [TypeGraphQL.Field(_type => [TodoWhereInput_1.TodoWhereInput], {
                nullable: true
            })];
        ...
        TodoWhereUniqueInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TodoWhereUniqueInput = _classThis;
})();
