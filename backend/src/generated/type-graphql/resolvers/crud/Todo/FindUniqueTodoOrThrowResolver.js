...
exports.FindUniqueTodoOrThrowResolver = void 0;
const TypeGraphQL = __importStar(require("type-graphql"));
const Todo_1 = require("../../../models/Todo");
const helpers_1 = require("../../../helpers");
let FindUniqueTodoOrThrowResolver = (() => {
    ...
    var FindUniqueTodoOrThrowResolver = _classThis = class {
    ...
    __setFunctionName(_classThis, "FindUniqueTodoOrThrowResolver");
    (() => {
        ...
        FindUniqueTodoOrThrowResolver = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return FindUniqueTodoOrThrowResolver = _classThis;
})();
exports.FindUniqueTodoOrThrowResolver = FindUniqueTodoOrThrowResolver;
