...
let AggregateUserResolver = (() => {
    ...
    var AggregateUserResolver = _classThis = class {
    ...
    __setFunctionName(_classThis, "AggregateUserResolver");
    (() => {
        ...
        AggregateUserResolver = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return AggregateUserResolver = _classThis;
})();
