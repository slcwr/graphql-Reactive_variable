...
const UserCreateNestedOneWithoutTodosInput_1 = require("../inputs/UserCreateNestedOneWithoutTodosInput");
let TodoCreateInput = (() => {
    let _classDecorators = [TypeGraphQL.InputType("TodoCreateInput", {})];
    ...
    var TodoCreateInput = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "TodoCreateInput");
    (() => {
        ...
        _user_decorators = [TypeGraphQL.Field(_type => UserCreateNestedOneWithoutTodosInput_1.UserCreateNestedOneWithoutTodosInput, {
                nullable: false
            })];
        ...
        TodoCreateInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TodoCreateInput = _classThis;
})();
