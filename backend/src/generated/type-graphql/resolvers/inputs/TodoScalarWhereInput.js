...
exports.TodoScalarWhereInput = void 0;
const TypeGraphQL = __importStar(require("type-graphql"));
const DateTimeFilter_1 = require("../inputs/DateTimeFilter");
const IntFilter_1 = require("../inputs/IntFilter");
const StringFilter_1 = require("../inputs/StringFilter");
let TodoScalarWhereInput = (() => {
    let _classDecorators = [TypeGraphQL.InputType("TodoScalarWhereInput", {})];
    ...
    var TodoScalarWhereInput = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "TodoScalarWhereInput");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _AND_decorators = [TypeGraphQL.Field(_type => [TodoScalarWhereInput], {
                nullable: true
            })];
        _OR_decorators = [TypeGraphQL.Field(_type => [TodoScalarWhereInput], {
                nullable: true
            })];
        _NOT_decorators = [TypeGraphQL.Field(_type => [TodoScalarWhereInput], {
                nullable: true
            })];
        ...
        TodoScalarWhereInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TodoScalarWhereInput = _classThis;
})();
exports.TodoScalarWhereInput = TodoScalarWhereInput;
