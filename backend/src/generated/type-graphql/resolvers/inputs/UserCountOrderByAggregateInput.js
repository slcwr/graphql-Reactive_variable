...
let UserCountOrderByAggregateInput = (() => {
    let _classDecorators = [TypeGraphQL.InputType("UserCountOrderByAggregateInput", {})];
    ...
    var UserCountOrderByAggregateInput = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "UserCountOrderByAggregateInput");
    (() => {
        ...
        UserCountOrderByAggregateInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UserCountOrderByAggregateInput = _classThis;
})();
