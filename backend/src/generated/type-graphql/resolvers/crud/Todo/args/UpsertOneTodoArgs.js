...
let UpsertOneTodoArgs = (() => {
    ...
    var UpsertOneTodoArgs = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "UpsertOneTodoArgs");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _where_decorators = [TypeGraphQL.Field(_type => TodoWhereUniqueInput_1.TodoWhereUniqueInput, {
                nullable: false
            })];
        _create_decorators = [TypeGraphQL.Field(_type => TodoCreateInput_1.TodoCreateInput, {
                nullable: false
            })];
        _update_decorators = [TypeGraphQL.Field(_type => TodoUpdateInput_1.TodoUpdateInput, {
                nullable: false
            })];
        ...
        UpsertOneTodoArgs = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UpsertOneTodoArgs = _classThis;
})();
