...
let TodoMinOrderByAggregateInput = (() => {
    let _classDecorators = [TypeGraphQL.InputType("TodoMinOrderByAggregateInput", {})];
    ...
    var TodoMinOrderByAggregateInput = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "TodoMinOrderByAggregateInput");
    (() => {
        ...
        TodoMinOrderByAggregateInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TodoMinOrderByAggregateInput = _classThis;
})();
