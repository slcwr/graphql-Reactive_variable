...
let NestedDateTimeFilter = (() => {
    let _classDecorators = [TypeGraphQL.InputType("NestedDateTimeFilter", {})];
    ...
    var NestedDateTimeFilter = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "NestedDateTimeFilter");
    (() => {
        ...
        _not_decorators = [TypeGraphQL.Field(_type => NestedDateTimeFilter, {
                nullable: true
            })];
        ...
        NestedDateTimeFilter = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return NestedDateTimeFilter = _classThis;
})();
