...
let FindManyUserResolver = (() => {
    ...
    var FindManyUserResolver = _classThis = class {
        users(ctx, info, args) {
    ...
    __setFunctionName(_classThis, "FindManyUserResolver");
    (() => {
        ...
        FindManyUserResolver = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return FindManyUserResolver = _classThis;
})();
