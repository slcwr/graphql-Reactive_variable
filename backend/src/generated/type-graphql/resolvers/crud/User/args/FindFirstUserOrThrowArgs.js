...
let FindFirstUserOrThrowArgs = (() => {
    ...
    var FindFirstUserOrThrowArgs = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "FindFirstUserOrThrowArgs");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _where_decorators = [TypeGraphQL.Field(_type => UserWhereInput_1.UserWhereInput, {
                nullable: true
            })];
        _orderBy_decorators = [TypeGraphQL.Field(_type => [UserOrderByWithRelationInput_1.UserOrderByWithRelationInput], {
                nullable: true
            })];
        _cursor_decorators = [TypeGraphQL.Field(_type => UserWhereUniqueInput_1.UserWhereUniqueInput, {
                nullable: true
            })];
        ...
        _distinct_decorators = [TypeGraphQL.Field(_type => [UserScalarFieldEnum_1.UserScalarFieldEnum], {
                nullable: true
            })];
        ...
        FindFirstUserOrThrowArgs = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return FindFirstUserOrThrowArgs = _classThis;
})();
