...
let FindManyTodoResolver = (() => {
    ...
    var FindManyTodoResolver = _classThis = class {
        todos(ctx, info, args) {
    ...
    __setFunctionName(_classThis, "FindManyTodoResolver");
    (() => {
        ...
        FindManyTodoResolver = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return FindManyTodoResolver = _classThis;
})();
