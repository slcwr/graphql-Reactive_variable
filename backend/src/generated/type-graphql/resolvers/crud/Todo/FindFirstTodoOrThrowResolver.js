...
exports.FindFirstTodoOrThrowResolver = void 0;
const TypeGraphQL = __importStar(require("type-graphql"));
const Todo_1 = require("../../../models/Todo");
const helpers_1 = require("../../../helpers");
let FindFirstTodoOrThrowResolver = (() => {
    ...
    var FindFirstTodoOrThrowResolver = _classThis = class {
    ...
    __setFunctionName(_classThis, "FindFirstTodoOrThrowResolver");
    (() => {
        ...
        FindFirstTodoOrThrowResolver = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return FindFirstTodoOrThrowResolver = _classThis;
})();
exports.FindFirstTodoOrThrowResolver = FindFirstTodoOrThrowResolver;
