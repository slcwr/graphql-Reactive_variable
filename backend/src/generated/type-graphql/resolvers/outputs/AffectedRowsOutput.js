...
let AffectedRowsOutput = (() => {
    let _classDecorators = [TypeGraphQL.ObjectType("AffectedRowsOutput", {})];
    ...
    var AffectedRowsOutput = _classThis = class {
        constructor() {
            this.count = __runInitializers(this, _count_initializers, void 0);
            __runInitializers(this, _count_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "AffectedRowsOutput");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _count_decorators = [TypeGraphQL.Field(_type => TypeGraphQL.Int, {
                nullable: false
            })];
        ...
        AffectedRowsOutput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return AffectedRowsOutput = _classThis;
})();
