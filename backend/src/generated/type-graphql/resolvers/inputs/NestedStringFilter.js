...
let NestedStringFilter = (() => {
    let _classDecorators = [TypeGraphQL.InputType("NestedStringFilter", {})];
    ...
    var NestedStringFilter = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "NestedStringFilter");
    (() => {
        ...
        _not_decorators = [TypeGraphQL.Field(_type => NestedStringFilter, {
                nullable: true
            })];
        ...
        NestedStringFilter = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return NestedStringFilter = _classThis;
})();
