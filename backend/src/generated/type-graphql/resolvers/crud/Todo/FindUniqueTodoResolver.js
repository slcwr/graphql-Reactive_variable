...
let FindUniqueTodoResolver = (() => {
    ...
    var FindUniqueTodoResolver = _classThis = class {
        todo(ctx, info, args) {
    ...
    __setFunctionName(_classThis, "FindUniqueTodoResolver");
    (() => {
        ...
        FindUniqueTodoResolver = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return FindUniqueTodoResolver = _classThis;
})();
