...
exports.UserUpdateToOneWithWhereWithoutTodosInput = void 0;
const TypeGraphQL = __importStar(require("type-graphql"));
const UserUpdateWithoutTodosInput_1 = require("../inputs/UserUpdateWithoutTodosInput");
const UserWhereInput_1 = require("../inputs/UserWhereInput");
let UserUpdateToOneWithWhereWithoutTodosInput = (() => {
    let _classDecorators = [TypeGraphQL.InputType("UserUpdateToOneWithWhereWithoutTodosInput", {})];
    ...
    var UserUpdateToOneWithWhereWithoutTodosInput = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "UserUpdateToOneWithWhereWithoutTodosInput");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _where_decorators = [TypeGraphQL.Field(_type => UserWhereInput_1.UserWhereInput, {
                nullable: true
            })];
        _data_decorators = [TypeGraphQL.Field(_type => UserUpdateWithoutTodosInput_1.UserUpdateWithoutTodosInput, {
                nullable: false
            })];
        ...
        UserUpdateToOneWithWhereWithoutTodosInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UserUpdateToOneWithWhereWithoutTodosInput = _classThis;
})();
exports.UserUpdateToOneWithWhereWithoutTodosInput = UserUpdateToOneWithWhereWithoutTodosInput;
