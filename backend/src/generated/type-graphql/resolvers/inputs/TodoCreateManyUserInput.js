...
exports.TodoCreateManyUserInput = void 0;
const TypeGraphQL = __importStar(require("type-graphql"));
let TodoCreateManyUserInput = (() => {
    let _classDecorators = [TypeGraphQL.InputType("TodoCreateManyUserInput", {})];
    ...
    var TodoCreateManyUserInput = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "TodoCreateManyUserInput");
    (() => {
        ...
        TodoCreateManyUserInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TodoCreateManyUserInput = _classThis;
})();
exports.TodoCreateManyUserInput = TodoCreateManyUserInput;
