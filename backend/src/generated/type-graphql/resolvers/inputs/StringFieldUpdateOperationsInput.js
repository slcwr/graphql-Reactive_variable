...
let StringFieldUpdateOperationsInput = (() => {
    let _classDecorators = [TypeGraphQL.InputType("StringFieldUpdateOperationsInput", {})];
    ...
    var StringFieldUpdateOperationsInput = _classThis = class {
        constructor() {
            this.set = __runInitializers(this, _set_initializers, void 0);
            __runInitializers(this, _set_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "StringFieldUpdateOperationsInput");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _set_decorators = [TypeGraphQL.Field(_type => String, {
                nullable: true
            })];
        ...
        StringFieldUpdateOperationsInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return StringFieldUpdateOperationsInput = _classThis;
})();
