...
let AggregateUser = (() => {
    let _classDecorators = [TypeGraphQL.ObjectType("AggregateUser", {})];
    ...
    var AggregateUser = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "AggregateUser");
    (() => {
        ...
        AggregateUser = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return AggregateUser = _classThis;
})();
