...
let NestedStringWithAggregatesFilter = (() => {
    let _classDecorators = [TypeGraphQL.InputType("NestedStringWithAggregatesFilter", {})];
    ...
    var NestedStringWithAggregatesFilter = _classThis = class {
        constructor() {
            ...
            this.not = (__runInitializers(this, _endsWith_extraInitializers), __runInitializers(this, _not_initializers, void 0));
    ...
    __setFunctionName(_classThis, "NestedStringWithAggregatesFilter");
    (() => {
        ...
        _not_decorators = [TypeGraphQL.Field(_type => NestedStringWithAggregatesFilter, {
                nullable: true
            })];
        __count_decorators = [TypeGraphQL.Field(_type => NestedIntFilter_1.NestedIntFilter, {
                nullable: true
            })];
        __min_decorators = [TypeGraphQL.Field(_type => NestedStringFilter_1.NestedStringFilter, {
                nullable: true
            })];
        __max_decorators = [TypeGraphQL.Field(_type => NestedStringFilter_1.NestedStringFilter, {
                nullable: true
            })];
        ...
        NestedStringWithAggregatesFilter = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return NestedStringWithAggregatesFilter = _classThis;
})();
