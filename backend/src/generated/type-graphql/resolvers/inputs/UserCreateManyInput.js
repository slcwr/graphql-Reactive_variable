...
let UserCreateManyInput = (() => {
    let _classDecorators = [TypeGraphQL.InputType("UserCreateManyInput", {})];
    ...
    var UserCreateManyInput = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "UserCreateManyInput");
    (() => {
        ...
        UserCreateManyInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UserCreateManyInput = _classThis;
})();
