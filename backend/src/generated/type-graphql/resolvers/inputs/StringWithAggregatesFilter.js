...
let StringWithAggregatesFilter = (() => {
    let _classDecorators = [TypeGraphQL.InputType("StringWithAggregatesFilter", {})];
    ...
    var StringWithAggregatesFilter = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "StringWithAggregatesFilter");
    (() => {
        ...
        _not_decorators = [TypeGraphQL.Field(_type => NestedStringWithAggregatesFilter_1.NestedStringWithAggregatesFilter, {
                nullable: true
            })];
        ...
        StringWithAggregatesFilter = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return StringWithAggregatesFilter = _classThis;
})();
