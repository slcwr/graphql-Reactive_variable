...
let UserRelationsResolver = (() => {
    ...
    var UserRelationsResolver = _classThis = class {
        todos(user, ctx, info, args) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                }).todos(Object.assign(Object.assign({}, args), (_count && (0, helpers_1.transformCountFieldIntoSelectRelationsCount)(_count))));
            });
        }
        constructor() {
    ...
    __setFunctionName(_classThis, "UserRelationsResolver");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _todos_decorators = [TypeGraphQL.FieldResolver(_type => [Todo_1.Todo], {
                nullable: false
            })];
        ...
        UserRelationsResolver = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UserRelationsResolver = _classThis;
})();
